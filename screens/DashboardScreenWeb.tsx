...
export default function DashboardScreenWeb({ navigation }: DashboardScreenProps) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.navigationButtons}>
        <TouchableOpacity style={styles.navButton} onPress={() => navigation.navigate("Statistics")}>
